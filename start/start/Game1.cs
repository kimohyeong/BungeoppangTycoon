...
namespace start
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            bgm = Content.Load<Song>("am_white");
            ...
            spManger.AddSprite(TEEL_STATE.OJ_CUSTOMER, Content, "customer/custom", (int)SPRITE_COUNT.SP_CUSTOMER);

            spManger.AddSprite(TEEL_STATE.OJ_WHITE, Content, "white");
            spManger.AddSprite(TEEL_STATE.OJ_WATCH, Content, "watch");
